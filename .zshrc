...
plugins=(git extract ansible archlinux debian common-aliases dnf git-prompt gitignore go nmap)
...
# Backward Reverse Search in zsh 
...
# nnn
export NNN_BMS='p:~/Projects/;d:~/Documents/;D:~/Downloads/'
export NNN_TRASH=2
